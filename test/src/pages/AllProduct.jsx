    ...
    const Collection =({collection}) =>{  
      ...
      let productFilter       
        if(collection.type===true){
            let productFilter1 = dataProducts.filter(product =>product.type==srt(collection.title1,true));
            let productFilter2=[];
            if (collection.title2) {
                productFilter2 = dataProducts.filter(product =>product.type==srt(collection.title2,true));                
               }
            productFilter =[...productFilter1,...productFilter2]
        }
        else{
             productFilter = dataProducts.filter(product =>product.category==srt(collection.title1,true))
        }
